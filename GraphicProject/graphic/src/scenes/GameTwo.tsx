...
export default class GameTwoScene extends Scene {
...
gameover:Object3D;
    ...
    public load(): void {
        this.game.loader.load({
            ...
            ["gun-model"]: { url: 'models/Tennis/Tennis.obj', type: 'text' },
            ["gun-texture"]: { url: 'models/Tennis/NewImage.jpg', type: 'image' },            
    ...
    public start(): void {
        ...
        this.textures['ground'] = TextureUtils.SingleColor(this.gl, [5, 55, 255, 255]);
...
//             let hfz=this.counter+ 100*triangle(this.time/10000);////motin in the direction of z-axis
// //you mx->arrow x_axis
//         this.objects['gun'].currentModelMatrix = mat4.fromRotationTranslationScale(mat4.create(), quat.fromEuler(quat.create(), -90, 0, -90), vec3.fromValues( this.mx,3,15), vec3.fromValues(0.1, 0.1, 0.1));
//             if (this.end_game==0)
//         {//pc
//             this.objects['house'].currentModelMatrix = mat4.fromRotationTranslationScale(mat4.create(), quat.fromEuler(quat.create(), -90, 0, -90), vec3.fromValues( this.h1x,3,0), vec3.fromValues(0.1, 0.1, 0.1));
//            /////motoin in the direction of z
//            ////x_at_shoot is the x position of the ball
...
/////////////////////////////////
         ...
         this.objects['gun'].currentModelMatrix = mat4.fromRotationTranslationScale(mat4.create(), quat.fromEuler(quat.create(), -90, 0, -90), vec3.fromValues( this.mx,3,15), vec3.fromValues(0.1, 0.1, 0.1));
            ...
            {
             this.objects['house'].currentModelMatrix = mat4.fromRotationTranslationScale(mat4.create(), quat.fromEuler(quat.create(), -90, 0, -90), vec3.fromValues( this.h1x,3,0), vec3.fromValues(0.1, 0.1, 0.1));
               /////motoin in the direction of z    /////motoin in the direction of z
...
//                 {
//                 this.flyz=hfz;
//                 if(this.flyz>15&&this.mx+2>=this.x_at_shoot&&this.mx-2<=this.x_at_shoot)//you win
//                 {
//                     this.flyz=20-hfz;
//                     this.x_at_shoot=this.mx;
//                     this.score++;
...
//             }
//                 else 
//                 if(this.flyz<0&&this.h1x+2>=this.x_at_shoot&&this.h1x-2<=this.x_at_shoot)//collide
//                 {
//                     this.flyz=hfz;
//                     this.x_at_shoot=this.h1x;
//                 }else this.score++;
...
//                if(this.h1x+2>=this.x_at_shoot&&this.h1x-2<=this.x_at_shoot)/////collided
//                 {
...
//      //this.objects['moon'].currentModelMatrix = mat4.fromRotationTranslationScale(mat4.create(), quat.fromEuler(quat.create(), 0, 360*this.time/1000, 0), vec3.fromValues(this.mx, this.my, this.flyz), vec3.fromValues(0, 0, 0))
//           this.flyobjfound=false;
//           this.checkmoon=1;*/
            //}
